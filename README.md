...
* В данной работе были реализованны основные слои DWH. 
* Процесс получения, преобразования и загрузки данных ETL процесс с помощью оркестратора __Airflow__ был освоен в полной мере.
